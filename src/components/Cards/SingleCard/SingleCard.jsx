        ...
        <article className="border border-black/10 relative flex flex-col w-full h-full rounded-xl bg-white text-gray-700 shadow-xl">
            ...
            <section className="p-6 flex-grow">
                <div className="flex items-center justify-between mb-3">
                    <h2 className="text-xl font-medium text-blue-gray-900 line-clamp-2">
                        {property.title}
                    </h2>
                    <p className="flex items-center gap-1.5 text-base text-blue-gray-900 flex-shrink-0">
                        {Icons.star}
                        {property.rating}
                    </p>
                </div>
                <p className="text-base text-gray-700 line-clamp-3">{property.description}</p>
            </section>
